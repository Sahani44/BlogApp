...
class PrsnlBlogListAd extends StatefulWidget {
  const PrsnlBlogListAd({ Key? key }) : super(key: key);

  @override
  _PrsnlBlogListAdState createState() => _PrsnlBlogListAdState();
}

class _PrsnlBlogListAdState extends State<PrsnlBlogListAd> {
