...
class BlogPage extends StatefulWidget {
  ...
  BlogPage({ required this.desc,required this.imageUrl,required this.title,required this.blogId,required this.edit });

  @override
  State<BlogPage> createState() => _BlogPageState(title: title,desc:desc,imageUrl: imageUrl,edit:edit,blogId:blogId);
}
...
class _BlogPageState extends State<BlogPage> {
  ...
  _BlogPageState({ required this.desc,required this.imageUrl,required this.title,required this.blogId,required this.edit });
  ...
  updateBlog() async {
    if(_formKey.currentState!.validate() && imageUrl !="")
    {
        ...
        crudMethods.updateData(blogMap,blogId).then((result) {
